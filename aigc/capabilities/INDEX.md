...
| `role-library` | 角色库 | active | `../roles/INDEX.md` | 3.2.1 | 维护当前有效角色边界、角色标签、角色添加时间、允许读取、允许写入、禁止范围、调用方式、角色资料、主会话能力隔离、批量视觉资源派发、实习开发角色派发、POE 领域任务派发、POE 角色技能入口、正式资源规格回收规则和多帧动画素材拆分边界。 |
